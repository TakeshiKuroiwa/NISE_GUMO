...
- UI/UX改善
- ドキュメント改善
- AIを活用した開発指示、レビュー観点、運用テンプレートの改善
...
AIエージェントに実装、調査、レビュー、ドキュメント整備を依頼する場合は、[AGENTS.md](./AGENTS.md) のテンプレートを活用してください。

特に、次の項目を明確にするとレビューしやすくなります。

- AIに期待する役割
- タスクの目的、スコープ、完了条件
- 入力として参照させるファイルやIssue
- 出力形式
- 禁止事項
- ローカル環境や進捗などのユーザー固有情報

AIの出力はそのまま採用せず、PR作成前に差分、動作、ドキュメント整合性を人間が確認してください。
